...
{
    // Keep the enum-based approach as requested - cleaner than manual byte constants
    // TODO: Investigate using instructionInfo(inst).name for automatic EVMC integration
    switch (inst) {
        ...
        case Instruction::BASEFEE: return "BASEFEE";  // Shanghai hardfork
        ...
        case Instruction::PUSH0: return "PUSH0";  // Shanghai hardfork
        ...
        default: {
            // Handle PUSH1-PUSH32, DUP1-DUP16, SWAP1-SWAP16 using opcode arithmetic
